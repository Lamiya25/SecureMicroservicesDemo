...
namespace Movies.Client.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(MoviesClientContext context, IMovieApiService movieApiService)
        {
            _context = context;
        ...
        {
              return movieApiService.GetMovies() != null ? 
                          View(await movieApiService.GetMovies()) :
